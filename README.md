...
This repo is the web client of GoPlan, you need to have a GoPlan API server running when using this client. You can find the GoPlan API server repo [here](https://github.com/goooooouwa/goplan-api).
